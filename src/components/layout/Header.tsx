	...
	return (
		<header className="sticky top-0 z-40 h-16 bg-white">
			<div className="mx-auto flex h-full max-w-[1200px] items-center justify-end px-6 md:px-10">
				{/* Grupo do usuário no lado direito */}
				<div className="flex items-center gap-3">
					...
					<button
						onClick={logout}
						className="flex items-center justify-center rounded-lg p-2 text-neutral-600 transition-colors hover:bg-neutral-100 hover:text-neutral-900 focus:outline-none focus:ring-2 focus:ring-green-500/40"
						title="Sair"
					>
